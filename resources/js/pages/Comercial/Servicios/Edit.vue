...
const form = useForm({
    ...
    unidad_medida: props.servicio.unidad_medida || 'UND',
    precio_referencial: props.servicio.precio_referencial || 0,
        ...
        <div class="form-container">
            <div class="header">
                <div>
                    ...
                    <p class="subtitle">Modifica los detalles del servicio</p>
                </div>
                <div class="actions">
                    ...
                    <button @click="submit" class="btn btn-primary" :disabled="form.processing">
                        {{ form.processing ? 'Guardando...' : 'Actualizar Servicio' }}
                    </button>
                </div>
            </div>
