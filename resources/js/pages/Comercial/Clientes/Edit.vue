...
const form = useForm({
    tipo_persona: props.cliente.tipo_persona || 'JURIDICA',
    tipo_documento: props.cliente.tipo_documento || 'RUC',
    numero_documento: props.cliente.numero_documento || '',
    razon_social: props.cliente.razon_social || props.cliente.nombre || '', // Fallback a nombre para legacy data
    email: props.cliente.email || '',
    telefono: props.cliente.telefono || '',
    direccion: props.cliente.direccion || '',
    estado: props.cliente.estado !== undefined ? Boolean(props.cliente.estado) : true,
})

const submit = () => {
    form.put(`/clientes/${props.cliente.uuid}`, {
        preserveScroll: true,
    })
}
        ...
        <div class="form-container">
            <div class="header">
                <div>
                    ...
                    <p class="subtitle">Modifica la información del cliente actual</p>
                </div>
                <div class="actions">
