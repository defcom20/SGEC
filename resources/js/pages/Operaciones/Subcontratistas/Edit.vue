...
const props = defineProps({
    subcontratista: Object,
})

const form = useForm({
    tipo: props.subcontratista.tipo || 'persona_natural',
    tipo_documento: props.subcontratista.tipo_documento || 'DNI',
    numero_documento: props.subcontratista.numero_documento || '',
    razon_social_nombre: props.subcontratista.razon_social_nombre || '',
    direccion: props.subcontratista.direccion || '',
    telefono: props.subcontratista.telefono || '',
    email: props.subcontratista.email || '',
    banco: props.subcontratista.banco || '',
    numero_cuenta: props.subcontratista.numero_cuenta || '',
    cci: props.subcontratista.cci || '',
    numero_cuenta_detraccion: props.subcontratista.numero_cuenta_detraccion || '',
    estado: props.subcontratista.estado || 'activo',
})

const submit = () => {
    form.put(route('subcontratistas.update', props.subcontratista.uuid), {
        preserveScroll: true,
    })
}
...
const breadcrumbs = [
    ...
    { title: 'Editar Subcontratista', href: '#' },
]
</script>

<template>
    <Head title="Editar Subcontratista" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="form-container">
            <div class="header">
                <div>
                    <h1>Editar Subcontratista</h1>
                    <p class="subtitle">Modifica los datos del maestro de obra o empresa</p>
                </div>
                <div class="actions">
