...
const onSearch = () => {
    ...
    timeout = setTimeout(() => {
        router.get('/proveedors', { search: searchQuery.value }, { preserveState: true, preserveScroll: true })
    }, 300)
}
...
const confirmDelete = (proveedor) => {
    modalConfig.value = {
        ...
        message: `¿Estás seguro de que deseas eliminar a "${proveedor.razon_social}"? Esta acción se puede revertir si se cuenta con historial.`,
...
const onDeleteConfirm = () => {
    const proveedor = modalConfig.value.target
    if (proveedor) {
        router.delete(`/proveedors/${proveedor.uuid}`, {
            preserveScroll: true,
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="page-container">
            <div class="header">
                <div>
                    <h1>Proveedores</h1>
                    <p class="subtitle">Administra tu red de proveedores y suministradores</p>
                </div>
                <Link href="/proveedors/create" class="btn btn-primary">
            ...
            <div class="controls-bar">
                <div class="search-box">
                    ...
                    <input
                        ...
                        @input="onSearch"
                        type="text"
                        placeholder="Buscar por razón social, RUC, rubro o email..."
                    >
                </div>
            </div>
            ...
            <div class="grid-container">
                <div
                    ...
                    :key="proveedor.id"
                    class="card-proveedor"
                >
                    <div class="card-header-styled">
                        <div class="status-indicator" :class="proveedor.estado === 'activo' ? 'active' : 'inactive'"></div>
                        <span class="doc-badge">{{ proveedor.tipo_documento }}: {{ proveedor.numero_documento }}</span>
                    </div>

                    <div class="proveedor-info">
                        <h3>{{ proveedor.razon_social }}</h3>

                        <div class="detail-row" v-if="proveedor.rubro">
                        ...
                        <div class="detail-row" v-if="proveedor.contacto">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                            <span>{{ proveedor.contacto }}</span>
                        </div>

                        <div class="detail-row" v-if="proveedor.email">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                            <span>{{ proveedor.email }}</span>
                        </div>

                        <div class="detail-row" v-if="proveedor.telefono">
                    ...
                    <div class="card-actions">
                        <Link :href="`/proveedors/${proveedor.uuid}/edit`" class="action-btn edit" title="Editar">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                        </Link>
                        <button @click="confirmDelete(proveedor)" class="action-btn delete" title="Eliminar">
            ...
            <!-- Paginación Simple -->
            <div v-if="proveedores.links && proveedores.data.length > 0" class="pagination">
                <Link
                    v-for="(link, key) in proveedores.links"
                    :key="key"
                    :href="link.url || '#'"
                    class="page-link"
            ...
            <div v-if="proveedores.data.length === 0" class="empty-state">
...
.card-proveedor::before {
    ...
    width: 100%;
    height: 2px;
    background: linear-gradient(90deg, var(--primary), var(--chart-3));
    opacity: 0.7;
}
