...
const submit = () => {
    form.put(`/proveedors/${props.proveedor.uuid}`, {
        preserveScroll: true,
    })
}
        ...
        <div class="form-container">
            <div class="header">
                <div>
                    ...
                    <p class="subtitle">Modifica la información del proveedor actual</p>
                </div>
                <div class="actions">
            ...
            <form @submit.prevent="submit" class="grid-layout">
                ...
                <div class="main-content">
                    ...
                    <div class="card" style="margin-top: 0.75rem;" v-if="proveedor.articulos && proveedor.articulos.length > 0">
                        <div class="card-header">
                        ...
                        <div class="card-body" style="padding: 0;">
                            <table class="compact-table">
                                ...
                                <tbody>
                                    <tr v-for="articulo in proveedor.articulos" :key="articulo.id">
                                        <td class="font-mono">{{ articulo.codigo }}</td>
                                        <td>{{ articulo.descripcion }}</td>
                                        <td>{{ articulo.unidad_medida }}</td>
                                        <td class="text-right">{{ articulo.precio_venta }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
.font-mono { font-family: monospace; font-size: 0.9em; }
</style>
